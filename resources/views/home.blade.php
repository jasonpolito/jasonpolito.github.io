...
@section('content')
    <x-container class="font-display text-{{ $ink }} max-w-3xl uppercase">
        <div class="mx-auto w-3/5 pt-8 sm:w-2/5">
        ...
        <x-card class="text-transparent">
            <div class="text-{{ $ink }} -mt-6 sm:-mt-8 lg:-mt-12">
                <h4 class="fitty nowrap-forced tracking-widest"><span class="relative -top-1 text-[0.6em]">✦</span> Over 10
                    Years of Experience <span class="relative -top-1 text-[0.6em]">✦</span></h4>
            </div>
        </x-card>
    </x-container>
@endsection
